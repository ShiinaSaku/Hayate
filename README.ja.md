...
| **暗号化**         | ephemeral X25519 鍵合意、HKDF-SHA256、フレーム単位の AEAD（AES-256-GCM または ChaCha20-Poly1305）。すべて [ring](https://github.com/briansmith/ring) 経由。 |
