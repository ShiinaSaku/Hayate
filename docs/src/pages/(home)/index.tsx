        ...
        <div className="flex flex-col items-center gap-12 lg:flex-row lg:items-center lg:justify-between">
          <div className="max-w-2xl text-center lg:text-left">
            ...
            <p className="mx-auto mb-8 max-w-xl text-lg text-body lg:mx-0 lg:max-w-md sm:text-xl">
              {tagline} Built on QUIC, X25519, and hardware-accelerated AEAD. No
              cloud, no accounts, no configuration.
            </p>
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-3 text-sm text-muted lg:justify-start">
              ...
              <Badge
                href="https://crates.io/crates/hayate"
          ...
          <div className="relative flex items-center justify-center lg:w-105">
            <div className="ide-mockup-card">
              <div className="flex items-center gap-2 border-b border-hairline px-4 py-2">
                ...
                <span className="ml-4 text-xs text-muted code">
                  hayate send ./photo.jpg
                </span>
              </div>
              <div className="grid gap-2 p-4">
                <div className="ide-pane">
                  <span className="text-muted-soft">$</span> hayate receive
                  --code alpha-bravo-charlie-delta
                </div>
                <div className="ide-pane">
                  <span className="text-muted-soft">$</span> hayate send
                  ./photo.jpg --code alpha-bravo-charlie-delta
                </div>
                <div className="ide-pane">
                  <span className="text-success">✓</span> Transferred 4.2 GB in
                  3.1s
                </div>
              </div>
            </div>
  ...
  const features = [
    {
      ...
      description:
        "4 MiB frames, 8-deep read-ahead, and 64/128 MiB QUIC windows saturate 10 GbE links.",
    },
    {
      icon: <Cpu className="h-6 w-6 text-primary" />,
      title: "Kernel-Async I/O",
      description:
        "Built on compio with io_uring, IOCP, or kqueue. Blocking crypto/compression runs on dedicated threads.",
    },
    {
      icon: <Radio className="h-6 w-6 text-primary" />,
      title: "Zero-Setup Discovery",
      description:
        "mDNS + UDP broadcast pairing means peers find each other with a four-word code phrase.",
    },
    {
      icon: <ShieldCheck className="h-6 w-6 text-primary" />,
      title: "End-to-End Encryption",
      description:
        "Ephemeral X25519 key agreement, HKDF-SHA256, and AES-256-GCM or ChaCha20-Poly1305.",
    },
    {
      icon: <Box className="h-6 w-6 text-primary" />,
      title: "Streamed Directories",
      description:
        "Folders are packed and streamed as tar, with path-traversal, symlink, and hardlink rejection.",
    },
    {
      icon: <Zap className="h-6 w-6 text-primary" />,
      title: "Smart Compression",
      description:
        "Zstd compression auto-skips pre-compressed formats so you do not waste CPU on archives or media.",
    },
  ];
      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-12 text-center">
          ...
          <p className="mt-4 text-muted">
            Designed for speed, privacy, and zero friction.
          </p>
        </div>
    ...
    <section className="border-y border-hairline bg-surface-card/30 px-4 py-20 sm:py-28">
      <div className="mx-auto max-w-4xl">
        <div className="mb-12 text-center">
          ...
          <p className="mt-4 text-muted">
            No configuration. No IP addresses. Just a code phrase.
          </p>
        </div>
        ...
        <Steps>
          <Step>
            ...
            <p className="text-body">
              The receiver opens a QUIC listener and waits for a matching
              sender.
            </p>
            <div className="mt-4">
              <CodeBlock
                code="hayate receive --code alpha-bravo-charlie-delta"
                title="Receiver"
              />
            </div>
          </Step>
          <Step>
            ...
            <p className="text-body">
              The sender broadcasts on mDNS and UDP, then negotiates an
              encrypted QUIC session.
            </p>
            <div className="mt-4">
              <CodeBlock
                code="hayate send ./photo.jpg --code alpha-bravo-charlie-delta"
                title="Sender"
              />
            </div>
          </Step>
          <Step>
            ...
            <p className="text-body">
              The receiver decrypts metadata, prompts for acceptance, and
              verifies the stream hash.
            </p>
            <div className="mt-4">
              <Callout type="success" title="Integrity guaranteed">
                Every transfer finishes with a BLAKE3 or SHA-256 checksum so you
                know the file arrived exactly as sent.
              </Callout>
            </div>
          </Step>
        </Steps>
    ...
    <section className="bg-canvas px-4 py-20 sm:py-28">
      <div className="mx-auto max-w-4xl">
        <div className="mb-10 text-center">
          ...
          <p className="mt-4 text-muted">
            One command on macOS, Linux, or Windows. Or build from source with
            Cargo.
          </p>
        </div>
          ...
          <div className="flex flex-col items-start gap-6 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-md text-body">
                Check out the CLI reference or dive into the security model to
                see exactly how Hayate protects your data.
              </p>
            </div>
